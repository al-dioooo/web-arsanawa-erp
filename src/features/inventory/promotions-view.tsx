  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_380px]">
        ...
        <div className="rounded-2xl border border-navy-100 bg-white p-6 shadow-card flex flex-col gap-4 self-start">
            ...
            <button
              ...
              className={`flex-1 pb-3 text-sm font-bold text-center border-b-2 cursor-pointer transition-colors ${
                formTab === "discount"
                  ...
                  : "border-transparent text-navy-500 hover:text-navy-950"
              }`}
            >
              Add Discount
            </button>
