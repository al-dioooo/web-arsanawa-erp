          ...
          <div className="grid gap-3 sm:grid-cols-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full min-h-11 pl-10 rounded-md border border-navy-100 bg-white text-sm text-navy-900 shadow-sm outline-none transition placeholder:text-navy-300 focus:border-teal-700 focus:ring-2 focus:ring-teal-700/15"
              />
            </div>
            ...
            <select
              ...
              className="min-h-11 rounded-md border border-navy-100 bg-white px-3 text-sm text-navy-900 shadow-sm outline-none transition focus:border-teal-700 focus:ring-2 focus:ring-teal-700/15"
            >
