...
/**
 * Canonical table shell shared across modules: a rounded card wrapper with a
 * consistent header row. Rows are passed as children so callers keep full
 * control of cell content.
 */
