          ...
          {isAdmin ? (
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="inline-flex min-h-10 items-center justify-center rounded-xl bg-teal-700 hover:bg-teal-900 px-5 text-sm font-semibold text-white transition-all shadow-sm cursor-pointer"
              >
            ...
            <Link
              href="/"
              className="mt-6 inline-flex min-h-10 items-center justify-center rounded-xl bg-teal-700 hover:bg-teal-900 px-5 text-sm font-semibold text-white transition-all shadow-sm cursor-pointer"
            >
