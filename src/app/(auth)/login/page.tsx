    ...
    <main className="grid min-h-dvh lg:grid-cols-[1fr_minmax(420px,580px)] xl:grid-cols-[1fr_640px] bg-navy-50">
      ...
      <section className="relative hidden lg:flex flex-col justify-between p-12 bg-teal-900 overflow-hidden select-none">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-20">
          <Image
            src="/brand/shape-flower-teal-lg.svg"
            alt=""
            width={800}
            height={800}
            className="absolute -top-40 -left-40 scale-150 rotate-45"
          />
          <Image
            src="/brand/shape-flame-orange.svg"
            alt=""
            width={600}
            height={600}
            className="absolute -bottom-20 -right-20 scale-110"
          />
        </div>
      ...
      {/* Login form panel */}
      <section className="flex flex-col justify-center items-center px-6 py-12 lg:px-16 xl:px-24 bg-white shadow-xl">
