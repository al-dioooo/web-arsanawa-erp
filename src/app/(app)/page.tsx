...
export default function HomePage() {
  ...
  return (
    <div className="grid gap-8">
      {/* Welcome Banner */}
      <section className="relative rounded-2xl border border-navy-100 bg-white p-8 shadow-card overflow-hidden">
            ...
            {moduleRegistry
              ...
              .map((m) => {
                ...
                return (
                  <article
                    key={m.key}
                    className={`flex flex-col justify-between rounded-2xl border bg-white p-6 shadow-card transition-all duration-300 ${
                      isEnabled
                        ? "border-navy-100 hover:-translate-y-1 hover:shadow-card-hover"
                  ...
                  >
                    ...
                    <div className="mt-6 pt-5 border-t border-navy-50">
                      {isEnabled ? (
                        <Link
                          href={m.route}
                          className="inline-flex w-full min-h-10 items-center justify-center rounded-xl text-xs font-bold text-white transition-all shadow-sm cursor-pointer hover:brightness-95"
