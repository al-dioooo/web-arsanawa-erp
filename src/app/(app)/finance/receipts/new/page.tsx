                    ...
                    <div className="grid gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <SelectDescription
                                ...
                                options={[
                                    { value: "bank_transfer", label: "Bank Transfer", description: "Record settlement through a bank account." },
                                    { value: "cash", label: "Cash", description: "Record direct cash settlement." },
                                    { value: "check", label: "Check / Giro", description: "Record check or giro settlement." },
                                ]}
                                    ...
                                    return (
                                        <tr key={inv.id} className="border-b border-navy-50 last:border-0 hover:bg-navy-50/30">
                                            ...
                                            <td className="py-3 pl-4">
                                                <Input
                                                    label={`Allocation for ${inv.invoice_number}`}
                                                    hideLabel
                                                    type="number"
                                                    min="0"
                                                    max={due}
