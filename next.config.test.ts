...
describe("next security headers", () => {
    ...
    it("builds a complete nonce-based production CSP without wildcard or unsafe-inline directives", () => {
        ...
        expect(policy).toContain("connect-src 'self' http://127.0.0.1:8000 http://localhost:8000 http://api-arsanawa-erp.test https://api-arsanawa-erp.test https://api-arsanawa-erp-production.up.railway.app http://103.93.160.222:8080 https://api-arsanawa-erp.duckdns.org http://api-arsanawa-erp.duckdns.org")
